...
class MainActivity : Activity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_CODE_OVERLAY) {
            ...
            // Ritardo di sicurezza di 500ms per consentire ad Android di registrare il consenso a sistema
            Handler(Looper.getMainLooper()).postDelayed({
                ...
                // Lasciamo che sia il ClickLoopManager a disegnare il mirino 1 secondo dopo in modo asincrono
                val btnToggleTarget = findViewById<Button>(R.id.btnToggleTarget)
                btnToggleTarget.text = "Nascondi Mirino Target"
                isTargetVisible = true
